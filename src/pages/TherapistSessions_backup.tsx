        ...
        <div className="flex flex-col gap-8 animate-fade-in relative">
          ...
          <Card className="w-full">
            <CardHeader>
              ...
              <CardDescription>Record and analyze therapy sessions</CardDescription>
            </CardHeader>
            <CardContent>
              {recordingError && (
                            ...
                            >
                              <div className="flex items-center gap-2 mb-2">
                                <div className={`p-1 rounded-full ${
                                  ...
                                  {entry.speaker === 'patient' ? <User size={14} /> : <User size={14} />}
                                </div>
                                <strong className="capitalize">{entry.speaker}</strong>
                              </div>
                              <p className="mb-2">{entry.utterance}</p>
